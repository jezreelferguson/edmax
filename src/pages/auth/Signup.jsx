        ...
        try{
            ...
            if(res.data.code === 201 || res.data.code === 200){
              ...
              navigate('/signin');
                ...
                Swal.fire({
                title: 'Error',
                text: res.data.message || 'Error Creating Account',
                icon: 'error'
              })
            }
        }catch(err){
            ...
            const errorText = errors ? Object.values(errors).flat().join(' ') : (message || 'Signup failed')
  ...
  return (
    ...
    <div className="page-title light-background">
      <div className="container d-lg-flex justify-content-between align-items-center">
        <h1 className="mb-2 mb-lg-0">Sign Up</h1>
